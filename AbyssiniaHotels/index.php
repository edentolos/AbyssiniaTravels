...
<!--div class="large-12 columns">
		<div class="large-3 columns centerdiv">
			<a href="index.php" class="button round fontslabo" style="background-color:#C0C0C0;">1</a>
...
<div class="row">
	...
	<p><b>Check Date</b></p><hr class="line">
			...
			<div class="row">
			  ...
			  <div class="row">
				<div class="large-12 columns" >
					<button name="submit" href="#" class="button small fontslabo" style="background-color:#C0C0C0; width:100%;" >Check Availability</button>
				</div>
			  </div>
			</form>
	</div>
