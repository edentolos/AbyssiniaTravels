...
session_start();
	include './auth.php';
	if(!$_SESSION['user']){
   		header("location: http://localhost/abyssiniatravel/customersignin.html");
   		die;
}
...
<div class="large-12 columns">
		...
		<div class="large-3 columns centerdiv">
			<a href="#" class="button round fontslabo" style="background-color:#C0C0C0;">3</a>
...
<div class="row">
		...
		<p><b>Your Reservation</b></p><hr class="line">
				...
				<div class="row">					
						<div class="large-12 columns" style="max-width:100%;">
							<p class="fontgrey borderstyle" style="text-align:center;">Amount<br>
	...
	<div class="large-8 columns blackblur fontcolor" style="padding-top:10px;">
		...
		<form action="insertandemail.php" method="post"  onSubmit="return validateForm(this);">
		  ...
		  <div class="row">
			<div class="large-12 columns" style="text-align:right;"><button type="submit" class="button small fontslabo" style="background-color:#C0C0C0;" onclick="return confirm('Are you sure you want to continue?')" >Confirm</button>
		  </div>
