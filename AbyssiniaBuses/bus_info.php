            ...
            <div class="col-md-8">
                        ...
                        <div class="jumbotron">
                            <div class="container-fluid">
                                ...
                                if (isset($_POST['book'])) {
                                    ...
                                    // $query = "INSERT INTO orders(bus_id,user_id,user_name,user_age,source,destination,date) VALUES($selected_bus, $_SESSION['user'],$source,$destination,now())";
                ...
                <?php 
                    ...
                    if (isset($_POST['submit_query'])) {
                        $user_name = ucfirst($_SESSION['user']) ;
                        if($user_name == "") {
                            $user_name = "(unknown)";
                        }
